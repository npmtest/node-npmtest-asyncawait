...
<div class="header low">
    ...
    <h2>
        ...
        Statements: <span class="metric">27.84% <small>(54 / 194)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">17.86% <small>(10 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">22.22% <small>(6 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">33.96% <small>(54 / 159)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
function makeAsyncFunc(config) {
    ...
    var result = function async(bodyFunc) {
        ...
        var semaphore = config.maxConcurrency ? <span class="branch-0 cbranch-no" title="branch not covered" >new Semaphore(config.maxConcurrency) </span>: Semaphore.unlimited;
        // Choose and run the appropriate function factory based on whether the result should be iterable.
        var makeFunc = config.isIterable ? <span class="branch-0 cbranch-no" title="branch not covered" >makeAsyncIterator </span>: makeAsyncNonIterator;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (config.acceptsCallback)
            ++arity;
...
function makeAsyncNonIterator(bodyFunc, config, semaphore) {
    ...
    return <span class="fstat-no" title="function not covered" >function nonIterable() {</span>
...
function makeFuncWithArity(fn, arity) {
    ...
    switch (arity) {
<span class="branch-0 cbranch-no" title="branch not covered" >        case 0: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f0() {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >        case 1: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f1(a) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
        case 2: return <span class="fstat-no" title="function not covered" >function f2(a, b) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-3 cbranch-no" title="branch not covered" >        case 3: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f3(a, b, c) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
        case 4: return <span class="fstat-no" title="function not covered" >function f4(a, b, c, d) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-5 cbranch-no" title="branch not covered" >        case 5: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f5(a, b, c, d, e) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-6 cbranch-no" title="branch not covered" >        case 6: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f6(a, b, c, d, e, f) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-7 cbranch-no" title="branch not covered" >        case 7: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f7(a, b, c, d, e, f, g) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-8 cbranch-no" title="branch not covered" >        case 8: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f8(a, b, c, d, e, f, g, h) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-9 cbranch-no" title="branch not covered" >        case 9: <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function f9(a, b, c, d, e, f, g, h, _i) {</span> <span class="cstat-no" title="statement not covered" >var i, l = arguments.length, r = new Array(l); <span class="cstat-no" title="statement not covered" ></span>for (i = 0; i &lt; l; ++i)</span></span></span>
<span class="cstat-no" title="statement not covered" >            r[i] = arguments[i]; <span class="cstat-no" title="statement not covered" ></span>return fn.apply(this, r); </span>};
<span class="branch-10 cbranch-no" title="branch not covered" >        default: <span class="cstat-no" title="statement not covered" >return fn; </span></span>// Bail out if arity is crazy high.
    }
}
