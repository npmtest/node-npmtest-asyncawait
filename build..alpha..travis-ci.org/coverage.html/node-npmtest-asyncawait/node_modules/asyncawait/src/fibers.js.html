...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-asyncawait/node_modules/asyncawait/src/fibers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-asyncawait/node_modules/asyncawait/src/fibers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-asyncawait/node_modules/asyncawait/src/</a> &#187; fibers.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (!global.asyncawait)
    global.asyncawait = {};
<span class="missing-if-branch" title="else path not taken" >E</span>if (!global.asyncawait.Fiber)
